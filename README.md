...
**CTF platform with modular challenges, auto-scoring, and multi-cloud deployment capabilities.**

---

##  Key Features
-  **3 Difficulty Tiers**: Crypto, Stego, Reverse Engineering challenges
